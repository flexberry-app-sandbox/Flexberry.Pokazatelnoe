...
namespace IIS.Pokazatelnoe
{
    ...
    public class Здание : ICSSoft.STORMNET.DataObject
    {
        ...
        private int fКолвоЭтажей;
        
        private int fвоЭтажей;
        
        private int fНомер;
        
        private IIS.Pokazatelnoe.Город fГород;
        ...
        /// КолвоЭтажей.
        /// </summary>
        // *** Start programmer edit section *** (Здание.КолвоЭтажей CustomAttributes)

        // *** End programmer edit section *** (Здание.КолвоЭтажей CustomAttributes)
        public virtual int КолвоЭтажей
        {
            get
            {
                // *** Start programmer edit section *** (Здание.КолвоЭтажей Get start)

                // *** End programmer edit section *** (Здание.КолвоЭтажей Get start)
                int result = this.fКолвоЭтажей;
                // *** Start programmer edit section *** (Здание.КолвоЭтажей Get end)

                // *** End programmer edit section *** (Здание.КолвоЭтажей Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (Здание.КолвоЭтажей Set start)

                // *** End programmer edit section *** (Здание.КолвоЭтажей Set start)
                this.fКолвоЭтажей = value;
                // *** Start programmer edit section *** (Здание.КолвоЭтажей Set end)

                // *** End programmer edit section *** (Здание.КолвоЭтажей Set end)
            }
        }
        ...
        [PropertyStorage(new string[] {
                "Город"})]
        [NotNull()]
        public virtual IIS.Pokazatelnoe.Город Город
        {
            get
            {
                ...
                IIS.Pokazatelnoe.Город result = this.fГород;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЗданиеE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗданиеE", typeof(IIS.Pokazatelnoe.Здание));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЗданиеL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗданиеL", typeof(IIS.Pokazatelnoe.Здание));
                }
            }
        }
    }
